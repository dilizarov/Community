    ...
    return (
      <li className="post">
        ...
        <div className="post-stats">
          ...
          <span className="post-replies-stats" onClick={this.toggleReplies}><i className="fa fa-comment-o"></i> <span className="post-replies-count">{this.props.post.replies_count}</span></span>
          {repliesLoader}
        </div>
        {repliesContent}
